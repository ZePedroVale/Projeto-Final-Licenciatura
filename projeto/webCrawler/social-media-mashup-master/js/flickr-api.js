...
//	var keyword = "animals";
	...
	return await fetch("https://api.flickr.com/services/rest/?method=flickr.photos.search&tags=" + keyword + "&accuracy=1&sort=date-posted-desc&safe_search=3&api_key=68a8deb4aba077832d5670bc7f2f361f&per_page=10&format=json&nojsoncallback=1", {
		mode: 'cors'
	}).then(function(resp){
		return resp.json();
