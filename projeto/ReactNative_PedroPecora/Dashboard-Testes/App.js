...
import TestsDash from "./views/TestsDash";
...
function LogoTitle() {
  return (
    <View>
      <Image
        source={{
          uri: "https://projetobioma.pt/wp-content/uploads/2021/05/logo-1-2048x812.png",
        }}
        style={{ width: 130, height: 45 }}
      />
      <View style={{ marginVertical: 10 }}>
        <Text>Smart Education tool</Text>
      </View>
    </View>
  );
}
...
function MyDrawer() {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Teste" component={TestsDash} />
      <Drawer.Screen name="Teste1" component={TestNew} />
    </Drawer.Navigator>
  );
}
