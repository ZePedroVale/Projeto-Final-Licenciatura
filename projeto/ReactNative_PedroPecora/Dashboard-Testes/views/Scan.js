    ...
    >
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <View style={{ width: 300, height: 400 }}>
          ...
          <Image
            style={{ width: 300, height: 400, right: "-30%" }}
            source={require("../assets/bife.png")}
            style={styles.alimentos}
          />
          <View style={{ flex: 1, flexDirection: "row", right: "-30%" }}>
            <View>
              <Button color="green" title="Sim" />
            </View>
            <View>
              <Button color="red" title="Não" />
            </View>
          </View>
        </View>
        ...
        <View style={{ width: 300, height: 400 }}>
          ...
          <Image
            style={{ width: 300, height: 400, right: "-30%" }}
            source={require("../assets/couve.png")}
            style={styles.alimentos}
          />
          <View style={{ flex: 1, flexDirection: "row", right: "-30%" }}>
            <View>
        ...
        <View style={{ width: 300, height: 400 }}>
          ...
          <Image
            style={{ width: 300, height: 400, right: "-30%" }}
            source={require("../assets/arroz.png")}
            style={styles.alimentos}
          />
          <View style={{ flex: 1, flexDirection: "row", right: "-30%" }}>
            <View>
