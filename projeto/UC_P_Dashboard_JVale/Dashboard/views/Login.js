...
import {View,ImageBackground,Image,Text,Button,TextInput,Alert} from "react-native";
...
const userList = [
    ...
    },
    {
        ...
        "password": "bg",
        "name": "Bill Gates",
        "description": "William Henry Gates III (born October 28, 1955) is an American business magnate, software developer, investor, author, and philanthropist. He is a co-founder of Microsoft Corporation",
    ...
    render() {
		...
		<ImageBackground style={styles.image}>
			<View style={styles.logoContainer}>
				<Text style={styles.textStl}>Utilizador: 
				<TextInput 
					style={styles.input}
					onChangeText={(value) => this.setStateFor("username", value)}
				/></Text> 
        		<Text style={styles.textStl}>Senha:  
				<TextInput 
					style={styles.input}
